...
function tandem_auto_load( $class ) {
	...
	if ( $classes === null ) {
		$classes = array(
			...
			'pullquote' => TANDEM_PATH . 'includes/patterns/class_quote-pull.php',
			'blockquote' => TANDEM_PATH . 'includes/patterns/class_quote-block.php',
			'section' => TANDEM_PATH . 'includes/patterns/class_section.php',
			'sectionheader' => TANDEM_PATH . 'includes/patterns/class_header-section.php',
			'subheader' => TANDEM_PATH . 'includes/patterns/class_header-sub.php',
			'image' => TANDEM_PATH . 'includes/patterns/class_image.php',
			'imageduo' => TANDEM_PATH . 'includes/patterns/class_image-duo.php',
			'caption' => TANDEM_PATH . 'includes/patterns/class_caption.php',
