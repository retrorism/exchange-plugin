...
class Exchange {
	...
	public function publish_featured_image( $context = '' ) {
		if ( $this->has_featured_image ) {
			$this->featured_image->clear_output();
